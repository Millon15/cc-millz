...
| [🎬 video-reader](plugins/video-reader/README.md) | Read one short clip end-to-end from local artifacts — provenance, frames, contact sheets, captions, offline-only transcription; the scratch tree is a printed three-rung ladder and a delete needs the tool's own marker. Extracted from a private monorepo. |
