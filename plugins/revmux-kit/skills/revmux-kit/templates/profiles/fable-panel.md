---
description: the same four lens splits on claude fable, no codex anywhere — for a machine without codex or a --no-codex run
...
agents:
  ...
  - {name: docs,         lenses: [docs, comments],               color: green}
